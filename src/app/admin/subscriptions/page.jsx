...
const page = () => {
  ...
  return (
    <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl-8">
      ...
      <div className="relative h-[80vh] max-w-full overflow-x-auto mt-4 rounded-lg border border-gray-300 bg-slate-50 shadow-sm scrollbar-hide">
        <table className="w-full text-sm text-gray-500">
          <thead className="text-xs text-left text-gray-700 uppercase bg-gray-50 border-b border-gray-300">
            <tr>
